...
export class CharacterSystem extends System {
    ...
    init(world) {
        ...
        if (!this.world) {
            ...
            console.log('[CharacterSystem] World available with', this.world.entities.length, 'entities');
        }
    }
    ...
    loadCharacterModel(entity) {
        ...
        console.log('#########', entity.getComponent('CharacterComponent'));
        try {
        ...
        fbxLoader.load(
            '/shared/models/character/model.fbx',
            (fbx) => {
    ...
    loadAnimations(entity) {
        ...
        const fbxLoader = new FBXLoader();
        const animations = [
            { name: 'idle', path: '/shared/models/character/idle.fbx' },
            { name: 'walk', path: '/shared/models/character/walk.fbx' },
            { name: 'run', path: '/shared/models/character/run.fbx' },
            { name: 'dance', path: '/shared/models/character/dance.fbx' }
        ];
